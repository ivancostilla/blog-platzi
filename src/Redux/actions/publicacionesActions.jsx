...
export const traerComentarios = (pub_key, index) => async (dispatch, getState) => {
    ...
    try {
        const respuesta = await axios.get(`https://jsonplaceholder.typicode.com/comments?postId=${publicacionSeleccionada.id}`)
